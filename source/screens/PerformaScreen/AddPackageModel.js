...
<ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.detailMainView}>
            <Text style={styles.detailText}>Original MRP</Text>
            <TextInput placeholder='' editable={false} style={styles.calenderInput}></TextInput>

        </View>

        <View style={styles.detailMainView}>
            <Text style={styles.detailText}>Nagotiated MRP</Text>
            <TextInput placeholder='' editable={false} style={styles.calenderInput1}></TextInput>

        </View>

        <View style={[styles.mrpMainView, { marginTop: constant.moderateScale(15)}]}>
                     <View style={[styles. mrpSubView, {}]}>
                     <Text style={styles.detailText}>Discount</Text>

                     </View>
                     <View style={styles.mrpSubView2}>
                     <TextInput placeholder='' editable={false} style={styles.calenderInput}></TextInput>
                     </View>
                  </View>
        {/* <View style={styles.detailMainView}>
