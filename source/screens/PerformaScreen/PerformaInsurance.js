...
export default function PerformaInsurance(props) {
  const { navigation, insurance_Data, generalMaster_Data, insuranceLoc_Data } =
    props;
  const dispatch = useDispatch();
  const { userData } = useSelector((state) => state.AuthReducer);
  const [selectState, setSelectState] = useState(true);
  const [nilDipSelectState, setNilDipSelectState] = useState(false);
  ...
  const fn_SaveInsurance = () => {
    ...
    tokenApiCall(
      SaveInsuranceCallBack,
      APIName.SaveProformaInsurance,
      "POST",
      param
    );
  };
  ...
  const updateInsuranceCheckedList = (selectedData) => {
    console.log("asasasasasasa", selectedData)
    // let tempArr = insurenceHeadList
    ...
    <View style={{ flex: 1, backgroundColor: "#E1E1E1" }}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.cal_SubView2}>
          ...
          <Pressable
            style={styles.selectMainView}
            onPress={() => setSelectState(!selectState)}
          >
            <Text style={styles.detailText}>Select</Text>
            <FastImage
              source={selectState ? images.checkIcon : images.unCheckIcon}
              style={styles.selectCheckIcon}
            />
          </Pressable>
          {/* </View> */}
          {/* <View
          ...
          >
            ...
            >
              <Pressable
                onPress={() => setNilDipSelectState(!nilDipSelectState)}
              >
                <FastImage
                  source={
                    nilDipSelectState ? images.checkIcon : images.unCheckIcon
                  }
                  style={[
              ...
              <SelectDropList
                ...
                buttonExt={styles.dropList}
                textExt={styles.dropListText}
                disable={(!selectState, !nilDipSelectState)}
                on_Select={(d) => setActionTypeValue(d)}
              />
            </View>
          </View>
          ...
          >
            ...
            <View style={{ flex: 1, flexDirection: "row" }}>
              <View style={[styles.bottomMainView2, {}]}>
                ...
                <Text style={styles.text6}>
                  0 <Text style={styles.text7}>(Before NCP)</Text>
                </Text>
              </View>
              <View style={[styles.bottomMainView2, {}]}>
            ...
            <View style={{ flex: 1, flexDirection: "row" }}>
              ...
              <View style={[styles.bottomMainView2, {}]}>
                <Text style={styles.text5}>Premium Amt</Text>
                <Text style={styles.text6}>
                  0 <Text style={styles.text7}>(Before NCB)</Text>
                </Text>
              </View>
            </View>
            ...
            <View style={{ flex: 1, flexDirection: "row" }}>
              <View style={[styles.bottomMainView2, {}]}>
                <Text style={styles.text5}>Premium Amt</Text>
                <Text style={styles.text6}>
                  0 <Text style={styles.text7}>(After NCB)</Text>
                </Text>
              </View>
              <View style={[styles.bottomMainView2, {}]}>
                <Text style={styles.text5}>Net Premium Amt</Text>
                <Text style={styles.text6}>
                  0 <Text style={styles.text7}>(After Discount)</Text>
                </Text>
              </View>
            </View>
