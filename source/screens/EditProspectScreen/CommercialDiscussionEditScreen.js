...
export default function CommercialDiscussionEditScreen(props) {
...
const [activeLease,setActiveLease] = useState(1)
  ...
  return (
    <View style={{ flex: 1, paddingBottom: constant.moderateScale(15) }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Pressable onPress={()=>setType(true)}   style={{
          ...
          <Text style={{
            ...
            color:type ? constant.baseColor : constant.textColor,
          }}>Finance</Text>
        </Pressable>
        </View>
        ...
        <Pressable  onPress={()=>setType(false)} style={{
          height:constant.moderateScale(35),
          // alignItems:'center',
          justifyContent:'center',
          ...
          <Text style={{
             fontFamily:constant.typeRegular,
             fontSize:constant.font18,
             color:type ? constant.textColor : constant.baseColor,
          }}>Lease</Text>
        </Pressable>
        </View>
      </View>
      ...
      <View style={{
        ...
        <Pressable onPress={()=>setActiveFinance(1)}
         style={{
          justifyContent:'center',
          alignItems:'center',
          flex:0.31,
          backgroundColor:activeFinance===1 ? constant.baseColor : constant.whiteColor,
          ...
          <Text style={{
            fontFamily:constant.typeRegular,
            fontSize:constant.font18,
            color:activeFinance===1 ? constant.whiteColor : constant.baseColor,
          }}>SBI</Text>
        </Pressable>
        <Pressable onPress={()=>setActiveFinance(2)}
         style={{
          justifyContent:'center',
          alignItems:'center',
          flex:0.31,
          backgroundColor:activeFinance===2 ? constant.baseColor : constant.whiteColor,
          paddingVertical:constant.moderateScale(8),
          borderWidth:1,
          borderRadius:10,
          borderColor:constant.baseColor,
          ...
          <Text style={{
            fontFamily:constant.typeRegular,
            fontSize:constant.font18,
            color:activeFinance===2 ? constant.whiteColor : constant.baseColor,
          }}>Aditya Birla</Text>
        </Pressable>

        <Pressable onPress={()=>setActiveFinance(3)}
         style={{
          justifyContent:'center',
          alignItems:'center',
          flex:0.31,
          backgroundColor:activeFinance===3 ? constant.baseColor : constant.whiteColor,
          paddingVertical:constant.moderateScale(8),
          borderWidth:1,
          borderRadius:10,
          borderColor:constant.baseColor,
          ...
          <Text style={{
            fontFamily: constant.typeRegular,
            fontSize:constant.font18,
            color:activeFinance===3 ? constant.whiteColor : constant.baseColor,
          }}>HDFC</Text>
        </Pressable>
          ...
          <View
            ...
            >
              <Text style={styles.detailText}>Finance</Text>
              <SelectDropList
                list={brandData}
              ...
              >
                <Text style={styles.detailText}>Down Payment</Text>
                <TextInput
                  placeholder="Enter here"
                  onChangeText={(d) => {
              ...
              >
                <Text style={styles.detailText}>Finance Amount</Text>
                <TextInput
                  placeholder="Enter here"
                  onChangeText={(d) => {
              ...
              >
                <Text style={styles.detailText}>Loan to Value</Text>
                <TextInput
                  placeholder="Enter here"
                  onChangeText={(d) => {
                    setDeviationPriceValue(Number(d) - Number(actualPriceValue))
              ...
              >
                <Text style={styles.detailText}>Cheque</Text>
                <TextInput
                  placeholder="Enter here"
                  onChangeText={(d) => {
                    setDeviationPriceValue(Number(d) - Number(actualPriceValue))
              ...
              >
                <Text style={styles.detailText}>Credit/Debit</Text>
                <TextInput
                  placeholder="Enter here"
                  onChangeText={(d) => {
                    setDeviationPriceValue(Number(d) - Number(actualPriceValue))
              ...
              >
                <Text style={styles.detailText}>Exchange Amount</Text>
                <TextInput
                  placeholder="Enter here"
                  onChangeText={(d) => {
                    setDeviationPriceValue(Number(d) - Number(actualPriceValue))
              ...
              >
                ...
                <TextInput
                  ...
                  editable={active === 1 ? false : true}
                  keyboardType="numeric"
                  style={[styles.input1,{height:constant.moderateScale(90)}]}
                >
                  {expectedPriceValue}
                </TextInput>
              </View>
          ...
          <View style={{
            ...
            <Pressable onPress={()=>setActiveLease(1)}
             style={{
              justifyContent:'center',
              alignItems:'center',
              flex:0.31,
              backgroundColor:activeLease ===1 ? constant.baseColor : constant.whiteColor,
              paddingVertical:constant.moderateScale(8),
              borderWidth:1,
              borderRadius:10,
              borderColor:constant.baseColor,
              ...
              <Text style={{
                fontFamily:constant.typeRegular,
                fontSize:constant.font18,
                color:activeLease ===1 ? constant.whiteColor : constant.baseColor,
              }}>ALD</Text>
            </Pressable>
            <Pressable onPress={()=>setActiveLease(2)}
             style={{
              justifyContent:'center',
              alignItems:'center',
              flex:0.31,
              backgroundColor:activeLease ===2 ? constant.baseColor : constant.whiteColor,
              paddingVertical:constant.moderateScale(8),
              borderWidth:1,
              borderRadius:10,
              borderColor:constant.baseColor,
              ...
              <Text style={{
                fontFamily:constant.typeRegular,
                fontSize:constant.font18,
                color:activeLease===2 ? constant.whiteColor : constant.baseColor,
              }}>Mahindra</Text>
            </Pressable>

            <Pressable onPress={()=>setActiveLease(3)}
             style={{
              justifyContent:'center',
              alignItems:'center',
              flex:0.31,
              backgroundColor:activeLease ===3 ? constant.baseColor : constant.whiteColor,
              paddingVertical:constant.moderateScale(8),
              borderWidth:1,
              borderRadius:10,
              borderColor:constant.baseColor,
              ...
              <Text style={{
                fontFamily: constant.typeRegular,
                fontSize:constant.font18,
                color:activeLease ===3 ? constant.whiteColor : constant.baseColor,
              }}>Kotak</Text>
            </Pressable>
              ...
              <View
                ...
                >
                  ...
                  <View
                    style={[
                      styles.detailMainView,
                      { opacity: active === 1 ? 0.4 : 1,marginTop:'4%' },
                    ]}
                  >
                    <Text style={[styles.detailText,{width:'100%'}]}>Tenure (in Months)</Text>
