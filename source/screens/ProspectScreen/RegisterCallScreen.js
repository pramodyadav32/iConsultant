...
export default function RegisterCallScreen(props) {
  ...
  const GetProspectMasterCallBack = async (res) => {
    console.log("search123456", JSON.stringify(res));
    if (res.statusCode === 200) {
  ...
  const GetActionMasterListCallBack = (res) => {
    console.log("search111111111", JSON.stringify(res));
    dispatch(emptyLoader_Action(false));
    if (res.statusCode === 200) {
  ...
  const fn_CreateProspect = () => {
    if (Object.keys(actionTypeValue).length === 0) {
      ...
      let param = {
        ...
        campaign:
          eventSourceData === undefined ? 0 : Number(eventSourceData?.serial),
        dealerCompanyDocket: "",
        corporateFlag: "N",
        dealType: "",
        approveFlag: "",
  ...
  const GetDemoVehicleListCallBack = async (res) => {
    console.log("searchvehi34", JSON.stringify(res));
    if (res.statusCode === 200) {
  ...
  const fn_EntityClick = (d) => {
    ...
    tokenApiCall(EntityClickCallBack, APIName.GetProspectMaster, "POST", param);
  };
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#E1E1E1" }}>
      ...
      <View style={[styles.mainTopView, styles.shadowProp]}>
          ...
          >
            ...
            <View style={styles.detailMainView}>
              ...
              <SelectDropList
                list={title}
                title={
                  titleValue?.description === undefined
                    ? " "
            ...
            <View style={styles.detailMainView}>
              <Text style={styles.detailText}>
                Location<Text style={styles.text2}>*</Text>
              </Text>
              <TextInput
            ...
            <View style={styles.detailMainView}>
              <Text style={styles.detailText}>
                PIN<Text style={styles.text2}>*</Text>
              </Text>
              <TextInput
                style={[styles.input1, styles.shadowProp2]}
                maxLength={6}
        ...
        {active === 2 && (
          ...
          >
            ...
            <View style={styles.detailMainView}>
              <Text style={styles.detailText}>Call Date<Text style={styles.text2}>*</Text></Text>
              <Pressable
                style={[styles.calenderMainView, styles.shadowProp2]}
            ...
            <View style={styles.detailMainView}>
              <Text style={styles.detailText}>Contacted?<Text style={styles.text2}>*</Text></Text>
              <SelectDropList
                list={referenceData}
                title={referenceValue?.description}
                buttonExt={styles.dropList}
            ...
            <View style={styles.detailMainView}>
              <Text style={styles.detailText}>Reason<Text style={styles.text2}>*</Text></Text>
              <SelectDropList
                list={referenceData}
                title={referenceValue?.description}
                buttonExt={styles.dropList}
            ...
            <View style={styles.detailMainView}>
              <Text style={styles.detailText}>Response<Text style={styles.text2}>*</Text></Text>
              <SelectDropList
                list={referenceData}
                title={referenceValue?.description}
                buttonExt={styles.dropList}
            ...
            <View style={styles.detailMainView}>
              <Text style={styles.detailText}>Status<Text style={styles.text2}>*</Text></Text>
              <SelectDropList
                list={referenceData}
                title={referenceValue?.description}
                buttonExt={styles.dropList}
            ...
            <View style={styles.detailMainView}>
              <Text style={styles.detailText}>Consultant<Text style={styles.text2}>*</Text></Text>
              <SelectDropList
                list={referenceData}
                title={referenceValue?.description}
                buttonExt={styles.dropList}
            ...
            <View style={[styles.bottomMainView, styles.shadowProp]}>
              <View style={styles.detailMainView}>
                <Text style={styles.detailText}>
              ...
              <View style={[styles.detailMainView, { alignItems: "flex-start" }]}>
                ...
                <TextInput
                  ...
                  style={[styles.commentInput, styles.shadowProp2]}
            ...
            <Button
              title="Proceed"
              buttonExt={[styles.proceedButton, styles.shadowProp]}
              textExt={styles.proccedButtonText}
