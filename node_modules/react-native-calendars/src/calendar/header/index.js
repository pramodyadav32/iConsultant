...
const CalendarHeader = forwardRef((props, ref) => {
    ...
    const renderWeekDays = useMemo(() => {
        ...
        return dayNames.map((day, index) => {
            ...
            return (<Text allowFontScaling={false} key={index} style={[dayStyle,{color:'#434343',width:'30%'}]} numberOfLines={1} accessibilityLabel={''}>
          {day}
        </Text>);
        });
    ...
    >
      <View style={[headerStyle,{borderRadius:10,backgroundColor:'#EEEEEE',paddingVertical:'2%',marginTop:'0.5%',elevation:0}]}>
        {_renderArrow('left')}
